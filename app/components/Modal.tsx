    ...
    <>
      {isVisible ? (
        <>
          ...
          <div className="tw:lg:h-auto tw:h-full tw:lg:w-[640px] tw:w-full tw:flex tw:flex-col tw:p-6 tw:mx-auto tw:lg:rounded-xl tw:bg-white tw:fixed tw:lg:top-1/5 tw:top-0 tw:left-0 tw:right-0 tw:z-10">
